...
def parse_args():
    ...
    parser.add_argument('--detpath', default='C:/Users/Administrator/Desktop/yolov5_obb/runs/val/exp3/Task1_{:s}.txt', help='test config file path')
    parser.add_argument('--annopath', default='C:/Users/Administrator/Desktop/yolov5_obb/dataset/val/labelTxt/{:s}.txt', help='checkpoint file')
    parser.add_argument('--imagesetfile', default='C:/Users/Administrator/Desktop/yolov5_obb/dataset/val/imgnamefile.txt', help='checkpoint file')
